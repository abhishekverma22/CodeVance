        ...
        <motion.div variants={itemVariants}>
          <Link to="/" className="z-50">
            <motion.h1
              ...
              className="text-xl sm:text-2xl md:text-3xl lg:text-5xl text-[#F4E7E1] font-thin font-ZenDots"
            >
              C<span className="mx-0.5 sm:mx-1 font-thin text-[#626F47]">o</span>deVance
            </motion.h1>
          </Link>
        </motion.div>
